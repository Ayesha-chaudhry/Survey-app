...
function handleSubmit(e:string){
  ...
  return (
    ...
    >
      <Box
        mt={{ sm: "80px", md: "20px", lg:"50px", xl: "44px", "2xl": "139px" }}
        ml={{ sm: "10px", mm:"18px", md: "84px", xl: "150px", "2xl": "162px" }}
      >
        <Box
          display={"flex"}
          alignItems={"center"}
        ...
        >
          <Text>9</Text>
          <BiRightArrowAlt />
          <Text mx={{ sm: "5px", md: "16px", xl: "16px" }}>
            What are some of the misconceptions about women
          </Text>
        </Box>
        <Text
          ...
          color={"#FFF"}
        >
          in the workplace you have encountered?
        </Text>
      </Box>
      <Box
        color={"#A5BFFF"}
        ...
        fontWeight={380}
        ml={{ sm: "32px", mm:"40px", md: "130px", xl: "200px", "2xl": "260px" }}
        ...
        {option.map((item, id: number) => {
          return (
            ...
            key={id}
              ...
              color={"#FFF"}
              ml={{ sm: "35px",mm:"40px", md: "132px", xl: "200px", "2xl": "249px" }}
              display={"flex"}
              alignItems={"center"}
