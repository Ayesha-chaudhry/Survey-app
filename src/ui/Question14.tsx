...
const option: optionType[] = [
  ...
  { opt_no: "D", option: "No, my parents do not allow me to work" },
];
...
const Question14 = () => {
  ...
  return (
    ...
    >
      <Box
        mt={{ sm: "80px", md: "70px", xl: "84px", "2xl": "106px" }}
        ...
        {option.map((item, id: number) => {
          return (
            ...
            key={id}
              ...
              color={"#FFF"}
              ml={{ sm: "35px", mm:"40px", md: "132px", xl: "205px", "2xl": "276px" }}
              display={"flex"}
              alignItems={"center"}
