  ...
  return (
    ...
    >
      <Box
        ...
        ml={{ sm: "14px", mm: "18px", md: "84px", lg: "150px", "2xl": "162px" }}
      >
        <Box
          display={"flex"}
          alignItems={"center"}
        ...
        >
          <Text>7</Text>
          <BiRightArrowAlt />
          <Text mx={{ sm: "7px", mm: "8px", md: "16px", "2xl": "20px" }}>
            Do you think companies prefer to hire
          </Text>
        </Box>
        <Text
          ml={{ sm: "28px", mm: "30px", md: "44px", lg: "50px", "2xl": "100px" }}
          color={"#FFF"}
          fontWeight={300}
          fontSize={{
            sm: "14px",
      ...
      <Box
        ...
        fontWeight={380}
        ml={{ sm: "42px", mm: "46px", md: "130px", lg: "200px", "2xl": "259px" }}
      ...
      <Box
        ml={{ sm: "-20px", mm: "-16px", md: "70px", lg: "136px", "2xl": "200px" }}
