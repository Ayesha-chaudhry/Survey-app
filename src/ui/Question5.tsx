...
const option: optionType[] = [
  { opt_no: "A", option: "Full Time Employment" },
  { opt_no: "B", option: "Part Time Employment" },
  { opt_no: "C", option: "Self Employed" },
  { opt_no: "D", option: "Unemployed" },
  { opt_no: "E", option: "Homemaker" },
  { opt_no: "F", option: "Student" },
];
...
const Question5 = () => {
  ...
  return (
    ...
    >
      <Box
        mt={{ sm: "80px", md: "30px", lg: "74px", "2xl": "197px"}}
        ml={{ sm: "10px", mm:"18px", md: "84px", lg: "150px", "2xl": "162px" }}
      >
        <Box
          display={"flex"}
          alignItems={"center"}
        ...
        >
          ...
          <Text mx={{ sm: "2px", mm:"7px", md: "18px", "2xl": "20px" }}>
          Mind telling us your employment status?
          </Text>
        </Box>
      </Box>
      ...
      <Box
        ...
        fontWeight={380}
        ml={{ sm: "40px", mm:"55px", md: "136px", lg: "212px", "2xl": "249px" }}
        ...
        {option.map((item, id: number) => {
          return (
            ...
            cursor={"pointer"}
              ...
              color={"#FFF"}
              ml={{ sm: "40px", mm:"55px", md: "136px", lg: "210px", "2xl": "249px" }}
              display={"flex"}
              alignItems={"center"}
